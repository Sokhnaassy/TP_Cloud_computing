...
''' Bob a la clef publique (221, 11) et Catherine la clef (221, 7).
...
result = att_mod_com(c1, c2, e1, e2, n)
print('Le résultat correspond au message déchiffré m :', result)
